        ...
        <div class="checkoutWrap">
            ...
            <div class="checkoutRightSide">
                ...
                <form id="payment-form"  method="POST">
                    ...
                    <label for="address" style="color: black">Adress:</label>
                    <input type="text" class="formInput" id="address" name="address" placeholder="Type your address" required>
                    <div class="input-row">
                        <label for="county" style="color: black">County:</label>
                        <input type="text" class="formInput" id="county" name="county" placeholder="Type your county" required>
                        <label for="city" style="color: black">City:</label>
                        <input type="text" class="formInput" id="city" name="city" placeholder="Type your city" required>
                    </div>
                    <label for="country" style="color: black">Country:</label>
                    <input type="text" id="country" class="formInput" name="country" placeholder="Type your country" required>
